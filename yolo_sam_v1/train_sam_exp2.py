...
def test(model, bbox_coords_test, test_files):
    ...
    image_root = f"./data/{opt.dataset}/images/test"
    gt_root    = f"./data/{opt.dataset}/masks/test"
...
def train(
    ...
    for image_name in image_list:
        ...
        image_root = f"./data/{opt.dataset}/images/train"
        gt_root    = f"./data/{opt.dataset}/masks/train"
    ...
    torch.save(sam_model.state_dict(), f"{save_path}{model_name}{epoch}-last.pth")
